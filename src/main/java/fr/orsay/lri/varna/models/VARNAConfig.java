...
public class VARNAConfig implements Serializable, Cloneable {
  ...
  public static final Font DEFAULT_NUMBERS_FONT = new Font("SansSerif", Font.BOLD, 18);
  ...
  public void toXML(TransformerHandler hd) throws SAXException {
    ...
    atts.addAttribute(
        "", "", XML_VAR_BACKBONE_COLOR, "CDATA", XMLUtils.toHTMLNotation(_backboneColor));
    atts.addAttribute("", "", XML_VAR_HOVER_COLOR, "CDATA", XMLUtils.toHTMLNotation(_hoverColor));
    atts.addAttribute(
        "", "", XML_VAR_BACKGROUND_COLOR, "CDATA", XMLUtils.toHTMLNotation(_backgroundColor));
    ...
    atts.addAttribute(
        "", "", XML_VAR_SPECIAL_BASES_COLOR, "CDATA", XMLUtils.toHTMLNotation(_specialBasesColor));
    atts.addAttribute(
        "", "", XML_VAR_DASH_BASES_COLOR, "CDATA", XMLUtils.toHTMLNotation(_dashBasesColor));
  ...
  public void loadFromXMLAttributes(Attributes attributes) {
    ...
    _spaceBetweenBases =
        XMLUtils.getDouble(attributes, XML_VAR_SPACE_BETWEEN_BASES, DEFAULT_SPACE_BETWEEN_BASES);
